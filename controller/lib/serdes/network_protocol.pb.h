...
#define ControllerStatus_init_default            {0, 0, 0, 0, 0}
...
#define Packet_init_default                      {0, {Command_init_default}}
#define Command_init_zero                        {_CommandType_MIN, false, 0}
#define GuiAck_init_zero                         {0}
#define ControllerStatus_init_zero               {0, 0, 0, 0, 0}
...
#define Packet_init_zero                         {0, {Command_init_zero}}
...
#define ControllerValue_FIELDLIST(X, a) \
X(a, STATIC,   OPTIONAL, FLOAT,    value,             1)
...
X(a, STATIC,   ONEOF,    MESSAGE,  (payload,identification,payload.identification),   4) \
